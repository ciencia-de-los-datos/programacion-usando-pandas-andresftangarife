...
def pregunta_12():
    ...
    tbl2_12 = tbl2.groupby('_c0')['_c5'].apply(lambda x: ','.join(x.astype(str).sort_values())).reset_index()
...
def pregunta_13():
    ...
    return tbl0_tbl2.groupby("_c1")["_c5b"].sum()
